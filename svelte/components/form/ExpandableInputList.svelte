...
<script>import { createInputAriaDescribedby, interpolate } from "../../../ts/utils";
...
export let fieldSetId;
export let fieldSetLabel;
export let fieldSetErrorHeading = "Feil oppstod";
export let fieldSetError = void 0;
export let fieldSetHelpText = void 0;
export let expandableAriaLabel = "";
...
function createAriaLabel(showMore2) {
  if (showMore2) {
