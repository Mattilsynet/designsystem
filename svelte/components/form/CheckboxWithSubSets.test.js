...
describe('Checkbox with subsets', () => {
    ...
    test('Renders list of checkboxes with selected', async () => {
        ...
        const produksjonsdyr = getByLabelText(`${options[0].children[0].displayName} (${options[0].children[0].docCount})`);
    ...
    test('Check checked checkboxes', async () => {
        ...
        const subCategory = getByLabelText(`${options[0].children[0].displayName} (${options[0].children[0].docCount})`);
    ...
    test('Test that subcategories are unchecked when main category is unchecked', async () => {
        ...
        const mainCategoryCheckbox = getByLabelText(`${options[0].displayName} (${options[0].docCount})`);
        const subCategoryCheckbox = getByLabelText(`${options[0].children[0].displayName} (${options[0].children[0].docCount})`);
        ...
        const sub = getByLabelText(`${options[0].children[0].displayName} (${options[0].children[0].docCount})`);
...
function addChecked(keys, options) {
