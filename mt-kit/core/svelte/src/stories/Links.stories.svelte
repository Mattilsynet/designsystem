...
<Story name="Transportlenker" let:disableCss let:smallLinks let:twoColumns let:cards let:disabled>
  <div use:wrapInShadowDom={disableCss}>
    ...
    <ul class="list-unstyled col-1-span-3">
      <li>
        <h3>Default</h3>
        <a href="#" class="link--transport"> Dyr og dyrehold </a>
      </li>
      ...
      <li>
        <h3>Primary</h3>
        <a href="#" class="link--transport link--transport--primary"> Mat og vann </a>
      </li>
      ...
      <li>
        <h3>Primary Large</h3>
        <a href="#" class="link--transport link--transport--primary-large"> Fisk og akvakultur </a>
      </li>
      ...
      <li>
        <h3>Secondary</h3>
        <a href="#" class="link--transport link--transport--secondary"> Planter og dyrking </a>
      </li>
        ...
        >
          {#each cards as link, index}
            <li class={getColSpanClass(twoColumns, index)}>
              <a href={link.href} class="link--transport link--transport--secondary-large"
                >{link.text}</a
              >
            </li>
          {/each}
