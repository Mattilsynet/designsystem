export const markers = {
  ...
  success:
    '<svg xmlns="http://www.w3.org/2000/svg" width="44" height="55" fill="none"><path fill="#fff" stroke="#054" d="M6.803 7.03c8.395-8.707 22-8.707 30.394 0 8.404 8.717 8.404 22.857 0 31.574L22 54.282 6.803 38.604C-1.6 29.888-1.6 15.747 6.803 7.03Z"/><circle cx="22" cy="22" r="19" fill="#054449"/><path fill="#fff" d="M14.978 20.404 12.5 23.283l8.212 6.314L31.5 18.378l-2.608-2.292-8.162 9.003-5.752-4.685Z"/></svg>',
  neutral:
