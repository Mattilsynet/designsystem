          ...
          <ol class="mt-ol m-t-xxs sub-menu">
            <li class="menu-level-2">
              <a
                ...
                class="forward-arrow-small on-primary no-underline"
            ...
            {#each item.children || [] as child}
              <li class="menu-level-3">
                <a
                  ...
                  class="forward-arrow-small no-underline on-primary small-link"
    ...
    {:else}
      <li class="disclosure disclosure-no-border on-primary">
        <a
          ...
          class="disclosure-header no-underline layout-flex layout-flex--center-vertical layout-full-width on-primary menu-level-1 border-radius-0"
          aria-current={item.isActive ? 'page' : false}>
    ...
    {#each itemsRight as right}
      <li>
        <a
          ...
          class="no-underline on-primary menu-level-1 p-r-xxs forward-arrow-end border-radius-0 small-link"
