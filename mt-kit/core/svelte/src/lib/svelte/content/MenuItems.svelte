...
<ol class="mt-ol menu menu--icon border col-1-span-8" aria-labelledby={titleId}>
...
{#if itemsRight}
  <ol class="mt-ol menu border col-10-span-3">
    ...
    {#each itemsBottom as bottom}
      <li class="m-t-0">
        <a
          ...
          class="mt-link layout-flex layout-flex--center-vertical on-primary"
